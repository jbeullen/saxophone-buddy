...
- Loop the progression on a built-in piano (chords, the arpeggio, or both), with tempo, beats per chord and an optional click.
...
- `audio.js`: Web Audio piano synth (no samples to download)
